...
import { get as _get, isEmpty, set as _set, unset } from '@kernel-js/support';
...
var Adapter = function (_AbstractAdapter) {
  ...
  function Adapter() {
    ...
    if (!_this.hasSupport()) {
      throw new NotSupportedError(_this.constructor.name + ' not available.');
    }
  ...
  _createClass(Adapter, [{
    ...
    value: function has(key) {
      try {
        ...
        exists = _get(item.value, splitKey.nested, '309e17f396019483e8505150f357832c') !== '309e17f396019483e8505150f357832c';
    ...
    value: function get(key) {
      ...
      try {
        ...
        return _get(result.value, splitKey.nested, defaultValue);
      } catch (e) {
        throw new DataError(e);
      }
    }
    ...
    value: function set(key, value) {
      ...
      try {
        ...
        var current = this.get(splitKey.root),
            itemValue = _set(current || {}, splitKey.nested, value);
